...
| android | setting_battery_optimize_title_one_ui_above_s | This will improve reliability for incoming notifications and Mixin calls. Please select **Optimised** or **Unrestricted** in Settings > Battery. |     |     |     | これにより、通知の受信やTelegramの呼び出しに対する信頼性が向上します。「設定」→「バッテリー」をタップしてください。そして<b>「最適化」</b> もしくは <b>「制限なし」</b>を選択してください。 |
