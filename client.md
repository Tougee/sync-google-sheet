...
|     | multisig_unlocking_description | The request to revoke the multisig is currently under verification by the Mixin server. Please wait a moment. | 正在将撤销多签的请求发送到 Mixin 服务器验证，请稍候。 |     |     |     |
|     | multisig_unlocked_description |     |     |     |     |     |
