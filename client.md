...
| android, iOS | not_supported_deposit | Mixin ceases support for deposit service on the %1$s. You can continue to withdraw and transfer %1$s in the wallet balance. Read the document to **learn more**. | Mixin 钱包现已不支持 %1$s 充值，注意已转入的 %2$s 资产可以继续转账或提现，阅读文档**了解更多**。 |     |     |     |
...
| iOS, android | request_approval | Request approval | 允许请求 |     |     |     |
| iOS, android | allow_dapp_request_approval | Allow dapp to ask for your approval to make a transaction. | 允许 Dapp 向你发送请求，如转账请求等 |     |     |     |
