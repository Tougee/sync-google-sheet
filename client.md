...
| android, iOS | decode_transaction_failed | Transaction decoding failed, making it impossible to estimate asset changes. Be cautious and only sign transactions for dApps you trust. | 无法估计资产变化，注意只给您信任的应用程序签名。 |     |     |     |
