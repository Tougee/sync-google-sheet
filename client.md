...
| android | address_deleted_description | The request to delete the address has been confirmed by the Mixin server! If necessary, you can add the address again. | 地址已删除。 |     |     |     |
